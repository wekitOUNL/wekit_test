...
public class WEKITAnnotatable : WEKITFocusableObject {
    ...
    /// <summary>
    /// adds a new sensor annotation to this object. 
    /// The annotation will be placed in the user's gaze direction in front of this object. 
    /// </summary>
    void AddSensorAnnotation()
    {
        //Debug.Log("WEKITAnnotatable.AddAnnotation");
        GameObject annotationObject = AddAnnotation(WEKITGlobalsManager.Instance.sensorAnnotationObject);
    }
